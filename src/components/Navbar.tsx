    ...
    <nav className="fixed top-0 w-full bg-background/80 backdrop-blur-md z-50 border-b border-border">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <a href="#home" className="flex items-center">
          <span className="text-xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Succinct Labs</span>
        </a>
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <a href="#game" className="text-foreground/80 hover:text-primary transition-colors">Game</a>
          <a href="https://x.com/SuccinctLabs" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="border-primary text-primary hover:bg-primary/10">Follow on X</Button>
          </a>
        </div>
